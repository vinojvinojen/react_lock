...
const RemoteBypassSetOutputViaKeyFob = ({ macAddress, LockID}) => {
...
//     }
  ...
  return (
    <div>
   <fieldset>
  <legend>Remote By pass SetOutputVia KeyFob</legend>
  <table>
  <tbody>
    <tr>
        <tr>
    ...
    <tr>
    <td>
        <label htmlFor="count">Select a startEnrollment:</label>
        <select
          name="count"
          id="count"
...
export default RemoteBypassSetOutputViaKeyFob
